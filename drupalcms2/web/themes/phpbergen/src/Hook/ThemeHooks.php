...
namespace Drupal\phpbergen\Hook;
...
use Drupal\phpbergen\RenderCallbacks;
...
/**
 * Contains hook implementations for Phpbergen.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize Phpbergen's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('phpbergen') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['phpbergen_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('phpbergen');
  }
